...
<body>
    ...
    <header>
        ...
        <div class="texts">
            ...
            <p>Heeft u klachten of opmerkingen? <br>
            U kunt hieronder kiezen wat voor opmerkingen of klachten u wilt doorgeven aan ons. <br>
            Uw blijdschap is onze blijdschap. <br> <br> <br> <br> <br> 

            <a href="complimentenform.php">Complimenten form</a> <br>
            <a href="Medewerkerklachten.php">Mederwerkers klachten</a> <br>
            <a href="productklacht.php">Product klachten</a> <br>
            <a href="websiteklacht.php">Website klachten</a>
...
<br><br>
    <h1 class="waterfles">Products</h1>
            <p class="waterfles">----Trending Aankopen----</p>
